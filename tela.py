...
rad1 = Radiobutton(frameMeio, text='Homem', bg=cor2, font=('Arial 10'), value='Homem', variable=selecionado1).place(x=20, y=80)

rad2 = Radiobutton(frameMeio, text='Mulher', bg=cor2, font=('Arial 10'), value='mulher', variable=selecionado1).place(x=20, y=100)

selecionado2 = StringVar()

rad1 = Radiobutton(frameMeio, text='Homem', bg=cor2, font=('Arial 10'), value='Homem', variable=selecionado2).place(x=206, y=80)

rad2 = Radiobutton(frameMeio, text='Mulher', bg=cor2, font=('Arial 10'), value='mulher', variable=selecionado2).place(x=206, y=100)
